const lang = {
  ...
  'Chat.StreamWith.Title': 'Stream With...',
  'Chat.StreamWith.Description': 'To stream video with another app, enter these Server URL and Stream Key in your streaming app. Software encoding recommended (×264 in OBS)',
  'Chat.StreamWith.Link.Subtitle': 'Server URL',
  'Chat.StreamWith.StreamKey': 'Stream Key',
  'Chat.StreamWith.ClickButtonText': 'Once you start broadcasting in your streaming app, click Start Streaming below.',
  'Chat.StreamWith.StartStreamingBtn': 'START STREAMING',
  'Chat.StreamWith.ServerURL.Copied': 'Server URL copied.',
  'Chat.StreamWith.StreamKey.Copied': 'Stream key copied',
